...
#include <cstring>>
/**
  * @brief: C-string Concatenation and copying
...
int main(){
  //Concatenation
	...
	char dest[50] = "Hello ";
  char src[50] = "World!";  // static strings on stack, destination string has to be big enough
  ...
  char *dest1 = new char[30]{'F','i','r','e','l','o','r','d','\0'}; // dynamic array on the heap -> new
  char *source1 = 
  ...
  std::strncat(dest2,source2,6);  // how many characters from source --> 6
