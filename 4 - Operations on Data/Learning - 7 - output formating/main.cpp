...
int main(){
  ...
  // std::flush - flushes buffer of printedout stuff from std::cout
  //===================================================================
  std::cout << std::endl;
  ...
  // std::setfill('-') fills spaces with char
  std::cout << std::endl;
  ...
  //===================================================================
  std::cout << std::endl;
  // std::boolalpha - change 0/1 to false/true or std::noboolalpha to disable
  bool condition {true};
  ...
  //===================================================================
  std::cout << std::endl;
  // std::showpos - > show or hide + sign for positive numbers or std::noshowpos
  int pos_num {34};
  int neg_num {-45};
  ...
  //===================================================================
  std::cout << std::endl;
  // different number systems : std::dec, std::oct, std::hex -> ex << std::hex << neg_int ,< std::Endl
  int pos_int {717171};
  int neg_int {-47347};
